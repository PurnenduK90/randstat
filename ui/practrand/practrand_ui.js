/**
 * PractRand Web UI Dashboard Renderer
 * Renders the 10 PractRand tests evaluation table and metrics.
 */

function renderPractRandDashboard(container, evalResult, options = {}) {
  ...
  const rows = evalResult.entries.map(e => {
    ...
    return `
      <tr style="border-bottom:1px solid #1e293b;">
        ...
        <td style="padding:10px;color:#cbd5e1;font-size:12px;">${e.testType}</td>
  ...
  const html = `
    <div class="randstat-practrand-card" style="font-family:system-ui,sans-serif;background:#0f172a;color:#f8fafc;padding:24px;border-radius:12px;border:1px solid #1e293b;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <h3 style="margin:0;font-size:18px;font-weight:700;color:#38bdf8;">PractRand High-Throughput PRNG Suite</h3>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { renderPractRandDashboard };
}
