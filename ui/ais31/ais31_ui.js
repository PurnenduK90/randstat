/**
 * BSI AIS 20 / AIS 31 Web UI Dashboard Renderer
 * Renders the 9-test AIS 31 TRNG evaluation table and metrics.
 */

function renderAis31Dashboard(container, evalResult, options = {}) {
  ...
  const html = `
    <div class="randstat-ais31-card" style="font-family:system-ui,sans-serif;background:#0f172a;color:#f8fafc;padding:24px;border-radius:12px;border:1px solid #1e293b;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        <h3 style="margin:0;font-size:18px;font-weight:700;color:#38bdf8;">BSI AIS 20 / AIS 31 Physical TRNG Suite</h3>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { renderAis31Dashboard };
}
