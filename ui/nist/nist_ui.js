/**
 * NIST SP 800-22 Web UI Dashboard Renderer
 * Renders the 15-test NIST evaluation table and summary badges.
 */
  ...
  const rows = evalResult.entries.map(e => {
    ...
    return `
      <tr style="border-bottom:1px solid #1e293b;">
        <td style="padding:10px;color:#94a3b8;font-family:monospace;">${e.section}</td>
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { renderNistDashboard };
}
