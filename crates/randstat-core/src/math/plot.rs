...
//!
//! Generates interleaved `[xâ‚€, yâ‚€, xâ‚, yâ‚, â€¦]` coordinate arrays written into
//! a caller-supplied fixed-size buffer â€” no heap allocation required.
...
///
/// Points are interleaved: `[x0, y0, x1, y1, â€¦]`.
/// Returns the total number of `f64` values written (= 2 Ã— actual steps).
