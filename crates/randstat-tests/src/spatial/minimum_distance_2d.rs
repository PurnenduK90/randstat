...
//!
//! Places `n` random points in a 10000Ãƒâ€”10000 square and finds the minimum
//! distance between any two points. The square of this minimum distance
//! should follow an exponential distribution with mean ÃŽÂ» = 0.995 / nÃ‚Â²  Ãƒâ€” 10^8.
//!
...
impl StreamTest for MinimumDistance2DTest {
    ...
    fn evaluate(&self) -> TestResult {
        // TODO: decode pairs of 4-byte floats as (x, y) Ã¢Ë†Ë† [0, 10000)Ã‚Â²;
        //       compute all pairwise distances (O(nÃ‚Â²)); find minimum;
        //       compare dÃ‚Â²_min CDF to Exp(ÃŽÂ») using KS statistic.
